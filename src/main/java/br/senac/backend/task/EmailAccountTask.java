...
public class EmailAccountTask implements Runnable {
	...
	public void run() {
        ...
        try {
            ...
            helper.setText("<html><body><h1>Seu acesso será liberado em breve no aplicativo.</h1><p>Nossa equipe está analisando as informações inseridas no seu cadastro e em breve entraremos em contato.</p><p>Atenciosamente,</p><p>Equipe 4PET.</p><br><img src='cid:watermark'></body></html>", true);
